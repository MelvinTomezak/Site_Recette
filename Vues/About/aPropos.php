<?php include '../standard/entete.php'; ?>
    ...
    <p>Nous aimons partager nos recettes car nous croyons que la cuisine est un moyen de rassembler les gens et de célébrer la diversité culturelle. Nous aimons également aider les gens à découvrir de nouveaux ingrédients et techniques culinaires, et à améliorer leurs compétences en cuisine. En partageant nos recettes, nous espérons inspirer les gens à explorer de nouveaux horizons culinaires et à apprécier la nourriture de manière plus consciente et plus savoureuse.</p>

    <h2>Contactez-nous</h2>

    <p>Si vous avez des questions ou des commentaires à propos de notre site ou de nos recettes, n'hésitez pas à nous contacter à l'adresse suivante : <a href="mailto:contact@notresite.com">contact@notresite.com</a>.</p>
<?php
